...
static NSString* emptyImage = @"iVBORw0KGgoAAAANSUhEUgAAABkAAAAZCAQAAABu4E3oAAAAGElEQVR42mNkIBkwjmoZ1TKqZVTLENcCAEW6ABqcVA4WAAAAAElFTkSuQmCC";
...
- (void) setDisableUserLocaitonIcon: (BOOL)json {
    _disableUserLocationIcon = json;
    if (_disableUserLocationIcon) {
        _userLocationIcon = [emptyImage decodeBase64ToImage];
    } else {
        _userLocationIcon = [locationImage decodeBase64ToImage];
    }
    
    [_userLocationView.pin setIconWithImage: _userLocationIcon];
    [_userLocationView.arrow setIconWithImage: _userLocationIcon];
    _userLocationView.accuracyCircle.fillColor = UIColor.clearColor;
}
